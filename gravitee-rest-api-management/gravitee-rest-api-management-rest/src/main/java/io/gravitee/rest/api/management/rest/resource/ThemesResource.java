...
public class ThemesResource extends AbstractResource {
    ...
    public Object get() {
        try {
            ...
            ThemeEntity themeEntity = themes.iterator().next();
//        themeEntity.setOptionalLogo(null);
//        themeEntity.setLogo(null);
//        themeEntity.setBackgroundImage(null);
//        themeEntity.setLoader(null);
            return themeEntity;
